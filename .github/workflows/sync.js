...
async function runSync() {
  ...
  try {
    ...
    while (url) {
      console.log(`Đang tải dữ liệu từ Graph API... (Đã lấy được ${itemsToInsert.length} items)`);
    ...
    console.log(`Quét xong ${itemsToInsert.length} items. Đang đẩy vào Supabase...`);
